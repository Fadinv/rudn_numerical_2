...
### Изучите материал, посвящённый градиентным спускам, при поиске минимума функции многих переменных. Выполните три задания.

# Вариант заданий смотрите в таблице сами задания в учебнике ГРЕБЕННИКОВА (  https://pfur.sharepoint.com/:b:/s/2023290/EVj6wyM3I9BAu6PtHn5A-i8BUOiHb-0s1_gFuW2KSJF-MQ?e=xKHyTP )
# Задание 1 раздел 5.2 стр 93
# Задание 2 раздел 5.3 стр 97
# Задание 3 раздел 5.4 стр 101
# Распределие вариантов смотрите в сообщении в общем чате группы.
# Аносова Наталья Павловна: Распределение заданий (методы градиентного спуска). Задания…
# опубликовано в ЧМ осень 2023 бв4 или Общий в 20 апреля 2024 г. 8:23:27
